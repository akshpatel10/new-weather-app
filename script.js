let weather = {
    apiKey: "7092b58db67d28902e21db09747ed5a1",
    ...
    displayWeather: function (data) {
        ...
        // Daily data
        // document.querySelector(".daily-date1").innerHTML = convertors.epochConvertor(dt[0]).getDate()+" "+ convertors.epochConvertor(dt[0]).toLocaleString('en', {month: 'long'});
        ...
        // document.querySelector(".daily-date2").innerHTML = convertors.epochConvertor(dt).getDate()+" "+ convertors.epochConvertor(dt).toLocaleString('en', {month: 'long'});
...
let geocode = {
    ...
    fetchGeoCode: function (name) {
        fetch("https://api.openweathermap.org/geo/1.0/direct?q=" + name + "&appid=7092b58db67d28902e21db09747ed5a1")
            .then((response) => response.json())
...
// https://api.openweathermap.org/data/3.0/onecall?lat=22.31&lon=73.15&exclude=minutely&units=metric&appid=7092b58db67d28902e21db09747ed5a1

// AirQ: https://api.openweathermap.org/data/2.5/air_pollution?lat=22.30&lon=73.18&appid=7092b58db67d28902e21db09747ed5a1
